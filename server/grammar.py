...
# VPX1: deals with statements like "either x or y" where x or y are accidentally marked as nouns
# VPX1: {<VP>?(<NP>|<NPX>)?(<NP>|<NPX>)*<CC>+}
...
grammar = r"""
    NP: {(<DT>|<PDT>)?(<CD>)?(<JJ>|<JJR>|<JJS>)*(<NN>|<NNS>|<NNP>|<NNPS>|<CD>|(<ORGANIZATION>|<PERSON>|<LOCATION>|<DATE>|<TIME>|<MONEY>|<PERCENT>|<FACILITY>|<GPE>))+<,>*}
        {(<DT>|<PDT>)+(<JJ>|<JJR>|<JJS>)+<,>*}
        {<PRP>}
    VP: {(<DT>|<PDT>)?(<RB>|<RBR>|<RBS>)*(<MD><RB>)?(<VB>|<VBD>|<VBG>|<VBN>|<VBP>|<VBZ>)+<,>*}
